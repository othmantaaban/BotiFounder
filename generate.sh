echo ''
echo "Enter Link Project p or s (school or soutiren , p par defaut) :"
read Link
...
sed -i "s/export const apiUrl =.*/export const apiUrl = 'https:\/\/boti.education\/$Link\/$Alias\/botiapi\/';/g" "./src/environments/environment.prod.ts"
